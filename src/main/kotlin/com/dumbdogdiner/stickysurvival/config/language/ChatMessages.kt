...
class ChatMessages(
    ...
    val trackingStickObtain: String,
    val trackingStickLocate: String,
    val trackingStickEmpty: String,
    ...
    constructor(cfg: ConfigHelper) : this (
        ...
        cfg.loadMessage("tracking stick obtain"),
        cfg.loadMessage("tracking stick locate"),
        cfg.loadMessage("tracking stick empty"),
